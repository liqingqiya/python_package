# -*- coding: utf-8 -*-
#
# PyV8 documentation build configuration file, created by
...
latex_documents = [
  ('index', 'PyV8.tex', u'PyV8 Documentation',
   u'Flier Lu', 'manual'),
]
...
man_pages = [
    ('index', 'pyv8', u'PyV8 Documentation',
     [u'Flier Lu'], 1)
]
